...
$role_id = $_SESSION['role_id'] ?? null; // Récupère le rôle de l'utilisateur connecté
if ($role_id !== 1) {
...
<header class="navbar sticky-top bg-dark flex-md-nowrap p-0 shadow" data-bs-theme="dark">
  <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white" href="#">Zoo Arcadia</a>
  ...
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <div class="table-responsive small">
        <h3 class="mt-5" id="titreItem">Services Existants</h3>
        <table class="table table-striped">
          ...
          <tbody>
            <tr>
              <td>1</td>
              <td>Visite Guidée</td>
              <td>Une visite guidée de notre zoo avec un expert.</td>
              <td>
                <form action="php/dashboard.php" method="POST" style="display:inline;">
...
<footer >
  <div class="container text-center bg-light text-dark p-3 ">
